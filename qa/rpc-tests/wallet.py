...
#   c) node1 mines 32 blocks, so now node 0 has 60001dogec, node 1 has 4250dogec, node2 has none.
#   d) node0 sends 601 dogec to node2, in two transactions (301 dogec, then 300 dogec).
