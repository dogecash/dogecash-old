...
#error Client version information missing: version is not defined by dogecx-config.h or in any other way
#endif
...
/**
 * dogecxd-res.rc includes this file, but it cannot cope with real c++ code.
