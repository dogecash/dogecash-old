...
<context>
    ...
    <message>
        ...
        <translation>
&lt;html&gt;&lt;head/&gt;&lt;body&gt;&lt;p align="justify"&gt;
DogeCash - это форма цифровых онлайн-денег, использующая технологию блокчейн,
которая может быть легко переведена по всему миру, мгновенно и с практически
нулевой комиссией. DogeCash включает в себя лидирующую на рынке защиту и
«конфиденциальность», а также является первой PoS криптовалютой (Proof of Stake),
в которой реализована система стекинга ZeroCoin (zDOGEC) и Zerocoin.
&lt;/p&gt;&lt;p align="justify"&gt;
DogeCash использует консенсус PoS (Proof of Stake), позволяя всем владельцам DogeCash участвовать в заработке вознаграждений
...
 </translation>
    ...
    <message>
        ...
        <translation>
Мастернода - это компьютер, на котором запущен базовый кошелек DogeCash с полным узлом и для которого требуется обеспечение в 5000 DOGEC для обеспечения дополнительных услуг сети и, в свою очередь, регулярного получения части вознаграждения за блок. Эти услуги в себя включают:
...
<context>
    ...
    <message>
        ...
        <translation>Перерасчет предложения DOGEC...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отправить монеты (DOGEC)</translation>
    </message>
    <message>
        <source>DogeCash address or contact label</source>
        <translation>DogeCash адрес или лейбл контакта</translation>
