                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    CAmount dogecAvailableBalance = balance - immatureBalance;
    ...
    bool showWatchOnlyDOGECAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool showDOGECPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnlyDOGECPending = watchUnconfBalance != 0;
    bool showDOGECLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnlyDOGECLocked = nWatchOnlyLockedBalance != 0;
    ...
    ui->labelWatchAvailable->setVisible(showDOGECAvailable && showWatchOnly);
    ...
    ui->labelWatchPending->setVisible(showDOGECPending && showWatchOnly);
    ...
    ui->labelWatchLocked->setVisible(showDOGECLocked && showWatchOnly);
