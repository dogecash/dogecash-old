...
"DogeCash Core Wallet", Q_NULLPTR));
        ...
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "The masternode network is DogeCash's second layer network on top of the blockchain that enables our DAO to provide decentralized governance, treasury, and SwiftX transactions.", Q_NULLPTR));
    } // retranslateUi
