...
CoinControlDogeCWidget::CoinControlDogeCWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlDogeCWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select DOGEC Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("DOGEC");
    ...
    ui->labelValueAfter->setText("0.00 DOGEC");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 DOGEC");
    ui->labelValueFee->setText("0.00 DOGEC");
...
CoinControlDogeCWidget::~CoinControlDogeCWidget()
{
    delete ui;
}
