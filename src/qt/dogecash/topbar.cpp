    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopDogec}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    ui->labelPendingDogec->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance, nDisplayUnit));
