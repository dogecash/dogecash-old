...
The script [extract-osx-sdk.sh](https://github.com/dogecash-project/dogecash/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
dogecash/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/dogecash-project/dogecash/blob/master/doc/README_osx.md) for troubleshooting tips.