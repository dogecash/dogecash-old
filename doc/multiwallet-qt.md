...
In order to support loading of multiple wallets in dogecash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dogecash.cpp.
...
Changes to dogecash.cpp
----------------------
dogecash.cpp is the entry point into dogecash-qt, and as such, will require some minor modifications to provide hooks for
