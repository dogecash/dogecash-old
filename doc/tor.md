...
```
./dogecashd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:989
```
...
HiddenServicePort 989 127.0.0.1:6740
...
your dogecashd's P2P listen port (6740 by default).
```
