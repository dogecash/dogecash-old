...
git clone https://github.com/dogecash-crypto/dogecash.git
cd dogecash
...
```bash
    ...
    From https://github.com/dogecash-crypto/dogecash
...
For example:
```bash
URL=https://github.com/crowning-/dogecash.git
...
[dogecash/gitian.sigs](https://github.com/dogecash-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
